...
public class App {
    ...
    private static ArrayList<Integer> generateIntArrayList(int howMany) {
		...
		for(int i = 0; i < howMany; i++) {
			list.add(Integer.valueOf(RandomGenerator.nextInt(0, 10000)));
		}
...
/*                 System.out.printf("----- After deleting %d from tree\n", e.intValue());
    ...
    public static void main(String[] args) throws Exception {
        ...
        tft.addValue(11);
        tft.addValue(13);/*
        tft.addValue(17);//tft.printInOrder();
        tft.addValue(19);
        tft.addValue(23);
        tft.addValue(29);
        tft.addValue(31);
        tft.addValue(37);//tft.printInOrder();
        tft.addValue(41);
        tft.addValue(43);
        tft.addValue(47);//tft.printInOrder();
        tft.addValue(53);
        tft.addValue(59);
        tft.addValue(67);
        tft.addValue(71);
        ...
        tft.addValue(240);
        tft.addValue(260);
        tft.addValue(270);tft.printInOrder();
        tft.addValue(221);
        tft.addValue(222);
